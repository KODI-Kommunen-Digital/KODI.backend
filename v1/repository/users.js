...
const deleteForgotTokenForUserWithConnection = async function (
    userId,
    connection,
) {
...
const addForgotPasswordTokenWithConnection = async function (
    payload,
    connection,
) {
    const response = await database.createWithTransaction(
...
const getUserListingsFromDatabase = async function (
    userId,
    filters,
    cityMappings,
    pageNo,
