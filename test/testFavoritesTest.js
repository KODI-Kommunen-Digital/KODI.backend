...
// const data = require("./staticdata/favoritesStaticData.json")
...
describe('Favorites Endpoint Test', () => {
    ...
    it('get all favorites of a user', (done) => {
        let expectedData;
    ...
    it('get the favorites listing ', (done) => {
    ...
    // it('post a listing into favorites', (done) => {
    //     // let expectedData;

    //     new Promise((resolve) => {
    //             const requestBody = {cityId: 1, listingId: 10}
    ...
    // it('delete a listings from favorite', (done) => {
    //     let expectedData;
